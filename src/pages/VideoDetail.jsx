      ...
      <div className="w-full px-6 md:px-12 pt-6 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between gap-2.5">
          <button
            ...
            className="inline-flex items-center gap-1.5 sm:gap-2 text-xs font-bold text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 border border-slate-200 px-3 sm:px-4 py-2.5 sm:py-2 rounded-xl transition-all cursor-pointer shadow-xs active:scale-95 shrink"
          >
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 sm:px-4 py-2.5 sm:py-2 rounded-xl text-xs font-bold border transition-all cursor-pointer shadow-xs active:scale-95 shrink-0 ${
              isFav
                ? 'bg-red-50 text-red-600 border-red-200 hover:bg-red-100'
                : 'bg-slate-100 text-slate-700 border-slate-200 hover:bg-slate-200 hover:text-slate-900'
            }`}
          >
            <Heart size={14} className={`shrink-0 ${isFav ? 'fill-red-600 text-red-600' : ''}`} />
            <span className="hidden sm:inline">{isFav ? 'Saved to Favorites' : 'Add to Favorites'}</span>
            <span className="inline sm:hidden">{isFav ? 'Saved' : 'Favorite'}</span>
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-slate-950 border border-slate-900 h-64 sm:h-auto sm:aspect-video flex flex-col justify-between p-4 shadow-2xl group">
              {/* Clean Slightly Larger Centered REDWIRE Watermark Overlay */}
              <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none select-none">
                <div className="flex items-center gap-2.5 sm:gap-3.5 opacity-25">
                  <img src="/logo.png" alt="REDWIRE Logo" className="h-9 sm:h-12 md:h-16 w-auto object-contain filter drop-shadow-xl opacity-85" />
                  <span className="font-['Montserrat'] font-extrabold tracking-wider text-xl sm:text-3xl md:text-4xl leading-none drop-shadow-2xl text-white">
